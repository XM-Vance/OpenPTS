...
UPDATE monthly_trade_review SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE day_ahead_trade_review SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
