...
UPDATE real_time_spot_price SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE day_ahead_econ_price SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE node_spot_price_daily SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE price_sgcc SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE price_forecast_results SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE carbon_quotes SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
