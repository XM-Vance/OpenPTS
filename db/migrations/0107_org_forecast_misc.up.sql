...
UPDATE forecasts SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE grid_calculations SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE market_clearings SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE carbon_emissions SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE tariff_schemes SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE storage_schedules SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE medium_term_load_forecast SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE actual_operation SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE mechanism_energy_monthly SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE unified_load_curve SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE daily_release SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE real_time_generation SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
...
UPDATE system_alerts SET org_id = (SELECT id FROM organizations WHERE code='default') WHERE org_id IS NULL;
